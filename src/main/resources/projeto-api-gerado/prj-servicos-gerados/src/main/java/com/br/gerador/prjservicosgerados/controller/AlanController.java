...
@RestController
@RequestMapping("/alan")
public class AlanController extends BaseController {

	@Autowired
	private AlanServiceFachada alanServiceFachada;
	...
	public String listarTodos() {
		try {
			return this.gson.toJson(alanServiceFachada.listarTodos());
		} catch (Exception e) {
	...
	public String buscarPorId(Long id) {
		try {
			return this.gson.toJson(alanServiceFachada.buscarPorId(id));
		} catch (Exception e) {
			return gson.toJson(e.getMessage());
		}
	}
	...
	public String salvar(Alan alan) {
		try {
			return gson.toJson(alanServiceFachada.salvar(alan));
		} catch (Exception e) {
			return gson.toJson(e.getMessage());
		}
	}
	...
	public String editar(@PathVariable("id") Long id, @RequestBody Alan alan) {
		try {
			alan.setId(id);
			return gson.toJson(alanServiceFachada.editar(alan));
		} catch (Exception e) {
			return gson.toJson(e.getMessage());
		}
	}
