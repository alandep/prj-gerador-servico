...
import com.br.gerador.prjservicosgerados.model.repository.CarteiraRepository;                                              
 ...
 */                                                                                                                    
@Service                                                                                                               
public class CarteiraService extends BaseService implements CarteiraServiceFachada {                                           
	 ...
	 */                                                                                                                   
	@Autowired                                                                                                            
	private CarteiraRepository geradorRepository;                                                                             
	...
	@Override                                                                                                             
	public List<Carteira> listarTodos() throws Exception {                                                                    
		List<Carteira> retorno = new ArrayList<Carteira>();                                                                       
		try {                                                                                                             
			retorno = this.geradorRepository.findAll();                                                                   
		} catch (Exception e) {                                                                                           
			super.LOGGER.error("Ocorreu um erro na classe: CarteiraService >> listarTodos(): " + e.getMessage());             
	...
	@Override                                                                                                             
	public Carteira buscarPorId(Long id) throws Exception {                                                                   
		Optional<Carteira> retorno = null;                                                                                    
		try {                                                                                                             
			retorno = this.geradorRepository.findById(id);                                                                
		} catch (Exception e) {                                                                                           
			super.LOGGER.error("Ocorreu um erro na classe: CarteiraService >> buscarPorId(Long id): " + e.getMessage());      
			throw new Exception(gson.toJson(retornoException));                                                           
		}                                                                                                                 
		return retorno.get();                                                                                             
	}                                                                                                                     
	...
	public Carteira salvar(Carteira carteira) throws Exception {                                                                      
		Carteira retorno = new Carteira();                                                                                        
		try {                                                                                                             
			validarCamposObrigatorioSalvar(carteira);                                                                         
			retorno = this.geradorRepository.save(carteira);                                                                  
		} catch (Exception e) {                                                                                           
			super.LOGGER.error(                                                                                           
					"Ocorreu um erro na classe: CarteiraService >> salvar(ObjetoDominio objetoDominio): " + e.getMessage());  
			throw new Exception(gson.toJson(retornoException));                                                           
		}                                                                                                                 
		return retorno;                                                                                                   
	}                                                                                                                     
	 ...
	 * @throws Exception                                                                                                  
	 */                                                                                                                   
	private void validarCamposObrigatorioSalvar(Carteira carteira) throws Exception {                                             
		StringBuilder camposNaoInformados = new StringBuilder();                                                          
                                                                                                                       
		camposNaoInformados.append("[ ");                                                                                 
		if (carteira.getPreco() <= 0) {                                                                         
	...
	@Modifying                                                                                                            
	@Override                                                                                                             
	public Carteira editar(Carteira carteira) throws Exception {                                                                      
		Carteira retorno = new Carteira();                                                                                        
		try {                                                                                                             
			retorno = this.geradorRepository.save(carteira);                                                                  
		} catch (Exception e) {                                                                                           
			super.LOGGER.error(                                                                                           
					"Ocorreu um erro na classe: CarteiraService >> editar(ObjetoDominio objetoDominio): " + e.getMessage());  
			throw new Exception(gson.toJson(retornoException));                                                           
		}                                                                                                                 
		return retorno;                                                                                                   
	}                                                                                                                     
	...
	public void deletar(Long id) throws Exception {                                                                       
		try {                                                                                                             
			...
			super.LOGGER.error("Ocorreu um erro na classe: CarteiraService >> (Long id): " + e.getMessage());               
			throw new Exception(gson.toJson(retornoException));                                                           
		}                                                                                                                 
	}                                                                                                                     
