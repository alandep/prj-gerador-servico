...
public class EvandroController extends BaseController {                                                                     
	...
	@Autowired                                                                                                              
	private EvandroServiceFachada evandroServiceFachada;                                                                          
	...
	public String listarTodos() {                                                                                           
		try {                                                                                                               
			return this.gson.toJson(evandroServiceFachada.listarTodos());                                                      
		} catch (Exception e) {                                                                                             
	...
	public String buscarPorId(Long id) {                                                                                    
		try {                                                                                                               
			return this.gson.toJson(evandroServiceFachada.buscarPorId(id));                                                    
		} catch (Exception e) {                                                                                             
			return gson.toJson(e.getMessage());                                                                             
		}                                                                                                                   
	}                                                                                                                       
	...
	public String salvar(Evandro evandro) {                                                                                       
		try {                                                                                                               
			return gson.toJson(evandroServiceFachada.salvar(evandro));                                                            
		} catch (Exception e) {                                                                                             
			return gson.toJson(e.getMessage());                                                                             
		}                                                                                                                   
	}                                                                                                                       
	...
	public String editar(@PathVariable("id") Long id, @RequestBody Evandro evandro) {                                             
		try {                                                                                                               
			evandro.setId(id);                                                                                                 
			return gson.toJson(evandroServiceFachada.editar(evandro));                                                            
		} catch (Exception e) {                                                                                             
			return gson.toJson(e.getMessage());                                                                             
		}                                                                                                                   
	}                                                                                                                       
